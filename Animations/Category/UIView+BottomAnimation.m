...
-(void) messageSlideOut:(NSString*)titleMessage
{
    ...
    [messageView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-20-[messageLabel]-20-|" options:0 metrics:nil views:views]];
    [messageView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[messageLabel(30)]" options:NSLayoutFormatAlignAllLeft metrics:nil views:views]];
